...
Thinking if it makes sense to model a generic `Org unit` soon as you spot any org hierarchy?
Alternatively: If we were building `Facility`, `FacilityGroup`, `Organization` today with the benefit of hindsight, what would we have done differently?
